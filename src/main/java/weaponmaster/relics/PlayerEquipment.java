...
public class PlayerEquipment extends CustomRelic {
    ...
    public static final String IMG = WeaponMaster.makeResourcePath("relics/PlayerEquipment.png");
    public static final String OUTLINE = WeaponMaster.makeResourcePath("relics/PlayerEquipmentOutline.png");
