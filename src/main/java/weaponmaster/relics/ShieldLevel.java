...
public class ShieldLevel extends CustomRelic {
    ...
    public static final String IMG = WeaponMaster.makeResourcePath("relics/placeholder.png");//ShieldLevel
    public static final String OUTLINE = WeaponMaster.makeResourcePath("relics/placeholder_outline.png");//ShieldLevelOutline
